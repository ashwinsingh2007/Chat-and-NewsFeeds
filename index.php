...
<html lang="en-US">
    ...
    <head>
        ...
        <link rel='stylesheet' id='besty-style-css'  href='http://localhost/wordpress-4.1.1/wordpress/wp-content/themes/besty/style.css?ver=4.1.1' type='text/css' media='all' />
...
ajaxreq3.onreadystatechange=processresponse2;
var reqstr="online.php?username="+username;
ajaxreq3.open("GET",reqstr,true);
ajaxreq3.send(null);
}
...
if(ajaxreq3.readyState==4)
{
var res=document.getElementById("online");
res.innerHTML=ajaxreq3.responseText;
online2();
}
}
function online2()
{
       setTimeout(function () {online();},7000);
}
...
<script>
    online();
        ...
        <script type='text/javascript' src='http://localhost/wordpress-4.1.1/wordpress/wp-content/themes/besty/js/enscroll.js?ver=20120216'></script>
